...
# Load in data:
if (length(args) > 2) {  ##########################this is where data is loaded in, we might need to change this for our sample data, compare it to data provided byexample
#additionally, this is what the locus zoom back end code uses
	data = list()
